...
.PHONY: crrss-system-test crrss-integration-test
.PHONY: crrss-ci-build crrss-ci-test crrss-ci-all
...
# Run CRRSS system tests
crrss-system-test:
        @echo "========================================"
        @echo "Running CRRSS System Tests"
        @echo "========================================"
        @$(MAKE) -C $(CRRSS_DIR) system-test

# Run CRRSS integration tests
crrss-integration-test:
        @echo "==> Running CRRSS integration tests..."
        @$(MAKE) -C $(CRRSS_DIR) integration-test

# CI/CD build target
crrss-ci-build:
        @echo "==> CI: Building CRRSS..."
        @$(MAKE) -C $(CRRSS_DIR) ci-build

# CI/CD test target
crrss-ci-test:
        @echo "==> CI: Testing CRRSS..."
        @$(MAKE) -C $(CRRSS_DIR) ci-test

# CI/CD full pipeline
crrss-ci-all:
        @echo "========================================"
        @echo "Running CRRSS CI/CD Pipeline"
        @echo "========================================"
        @$(MAKE) -C $(CRRSS_DIR) ci-all
